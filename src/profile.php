...
// Fetch product data
$sql = mysqli_query($conn, "SELECT type_id, product_type FROM product_type");
          ...
          <div class="container-fluid">
            ...
            <div>
              <form action="php/adduser.php" method="POST">
                ...
                <input type="date" class="form-control" name="birthdate" placeholder="Birthdate Ex. MM/DD/YYYY" required>
                ...
                <input type="text" class="form-control" name="pass_word" placeholder="Password" required>
          ...
          <div class="form-group">
            ...
            <select class="form-control text-primary" required>
              ...
              <?php foreach ($data as $row): ?>
                <option value="<?= htmlspecialchars($row['type_id']) ?>">
          ...
          <form class="" method="POST">
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="productType" value="" placeholder="Enter product type..." required>
                <small class="text-muted">Example: Cold Coffee, Hot Coffee or Frappe etc</small>
              </div>
              <small class="text-muted"><em>Please double check information before submitting.</em></small>
            </div>
            <div class="modal-footer">
              <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
              <input type="submit" class="btn btn-primary" name="btnAdd" value="Add Product Type">
            </div>
          </form>
        </div>
      </div>
